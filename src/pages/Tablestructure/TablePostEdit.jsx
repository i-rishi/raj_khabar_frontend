...
export function TablePostEdit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        showToast("Table Post Updated Successfully!", "success");
        navigate("/table-management", { state: location.state });
      } else {
      ...
      <Box sx={{ width: "100%", maxWidth: 1400 }}>
        ...
        >
          <Box>
            ...
            <Typography variant="body2" sx={{ color: "#666", mt: 0.5 }}>
              Modify the table entry name and row values. Structure and categories are locked.
            </Typography>
          </Box>
        </Stack>
        ...
        <form onSubmit={handleSubmit} autoComplete="off" style={{ width: "100%" }}>
          <Grid container spacing={3} alignItems="flex-start">
            {/* Left Column: Post Settings & Actions */}
                ...
                >
                  ...
                  <Stack spacing={2.5}>
                    ...
                    <TextField
                      ...
                      helperText={
                        activeStructure
                          ? `Structure Columns: ${activeStructure.columns.length}`
                          : ""
                      }
                    />
                  </Stack>
                 ...
                 {columns.length > 0 ? (
                  ...
                  >
                    ...
                    <Typography variant="body2" sx={{ color: "#777", maxWidth: 400 }}>
                      No columns are defined for the mapped table structure of this post.
                    </Typography>
                  </Box>
                )}
              </Paper>
